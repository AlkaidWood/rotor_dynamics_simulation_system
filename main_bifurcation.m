...
for iPar = 1:1:bifurParNum
   % change running statues
    ...
    % calculate response
    TSTART = 0;
    TEND = accelerationTime + transientTime(iPar) + stableTime;
...
for iDof = 1:1:dofNum
    ...
    set(gcf,'Units','centimeters','Position',[6 6 14 5.5])
    set(gcf,'Visible','off','CreateFcn','set(gcf,''Visible'',''on'')')
    figureName =  figureIdentity{iDof};
    figurePath = 'G:/大学硕士/毕业论文/论文/result/rub/分岔图/';
